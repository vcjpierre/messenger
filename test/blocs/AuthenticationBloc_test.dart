...
import 'package:flutter_messenger/blocs/authentication/AuthenticationBloc.dart';
import 'package:flutter_messenger/blocs/authentication/AuthenticationEvent.dart';
import 'package:flutter_messenger/blocs/authentication/AuthenticationState.dart';
...
void main() {
  ...
  setUp(() {
    ...
    age = 23;
    username = 'johndoe';
    profilePictureUrl = 'http://www.github.com/vcjpierre';
    authenticationBloc = AuthenticationBloc(
